...
> [!NOTE]
> If you plan on using OCR features inside update_xkcd.py locally, make sure you have the Tesseract OCR engine installed on your system.
...
> You must use a dev server instead.
